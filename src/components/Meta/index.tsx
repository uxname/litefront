...
export const Meta = (props: IProps) => (
    <NextHead>
        ...
        <meta name="description" key={'desc'} content={props.description || defaults.description} />
        ...
        {/*<!-- Twitter Meta Tags -->*/}
        <meta name="twitter:title" key={'ttitle'} content={props.title || defaults.title} />
        <meta name="twitter:description" key={'tdesc'} content={props.description || defaults.description} />
        <meta name="twitter:image" key={'timg'} content={props.image || defaults.image} />
