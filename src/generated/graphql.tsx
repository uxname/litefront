...
export type AllFilmsQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', totalCount?: number | null, edges?: Array<{ __typename?: 'FilmsEdge', node?: { __typename?: 'Film', title?: string | null } | null } | null> | null } | null };


export const AllFilmsDocument = gql`
    query AllFilms($take: Int!) {
  allFilms(first: $take) {
    totalCount
    edges {
      node {
